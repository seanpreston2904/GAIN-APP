...
import { BoxArrowLeft, GearFill, HouseFill, PencilFill } from "react-bootstrap-icons";
                ...
                <div className="flex p-4 space-x-6 z-10">
                    ...
                    <div className="flex flex-grow space-x-5">
                        ...
                        <button className="flex my-auto space-x-2 text-slate-700">
                            ...
                            <h3 className="text-slate-700 font-semibold text-lg" onClick={() => {navigate("")}}>Home</h3>
                        </button>

                        <button className="flex my-auto space-x-2 text-slate-700" onClick={() => {navigate("mealcreator")}}>
                            <PencilFill className="my-auto text-xl"/>
                            <h3 className="text-slate-700 font-semibold text-lg">Meal Builder</h3>
                        </button>
